...
subtitle: "The math ([Geometries](#geo)), the idea ([CAD Model](#CAD-Model)), demonstrated outcome ([My Device in Action](#DIA)), and everything else about the resin-printed mold for the microfluidic device project!"
header:
  overlay_color: "#000"
  overlay_filter: "0.5"
...
---  
**The math ([Geometries](#geo)), the idea ([CAD Model](#CAD-Model)), demonstrated outcome ([My Device in Action](#DIA)), and everything else about the resin-printed mold for the microfluidic device project!**
{: .subtitle}
...
{% include gallery caption="The resin-printed mold (left) and the casted device (right)" %}
...
By utilizing the pinched flow fractionation, difference in particle size can determine separation. 
 <img src="assets/img/CADDrawing.png" alt="CAD Drawing" width="300" align="center">
1. *Pinch Width- 0.50 mm*
...
2. *Outlet Width- 3.655mm*
  ...
  - This was found using the outlet position equation below
...
5. *Large Reservoir Length- 25 mm*
