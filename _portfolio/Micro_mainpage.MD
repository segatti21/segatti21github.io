...
excerpt: "The math ([Geometries](#geo)), the idea ([CAD Model](#CAD-Model)), demonstrated outcome ([My Device in Action](#DIA)), and everything else about the resin-printed mold for the microfluidic device project!"
header:
  overlay_color: "#000"
  overlay_filter: "0.5"
