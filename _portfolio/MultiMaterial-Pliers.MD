...
---
The objective of this project is to leverage flexible and rigid materials to create a spring-loaded tool that works straight off the printer—or with minimal manual assembly—without requiring screws, glue, or post-processing. This can be done using print-in-place (PIP) techniques which has a variety of [applications](#apps) and materials.
...
### Best Material Combinations for PIP
#### *Rigid and Flexible Material* such as PLA and TPU, respectively, enables moving parts where rigid sections provide structure and TPU acts as a spring, hinge, or flex joint.
